...
function get_the_post_navigation($args = array())
{
	...
	$previous = get_previous_post_link(
		'<li class="page-item nav-previous">%link</li>',
		$args['prev_text'],
		$args['in_same_term'],
		$args['excluded_terms'],
		$args['taxonomy']
	...
	$next = get_next_post_link(
		'<li class="page-item nav-next">%link</li>',
		$args['next_text'],
		$args['in_same_term'],
		$args['excluded_terms'],
		$args['taxonomy']
	...
	if ($previous || $next) {
		$navigation = _navigation_markup('<ul class="pagination justify-content-center my-4">' . $previous . $next . '</ul>', $args['class'], $args['screen_reader_text'], $args['aria_label']);
	}
