                    ...
                    <div class="row">
                           ...
                           <div class="services-item">
                               <div class="services-icon">
                                   <div class="image-part">
                                       <img src="<?php bloginfo ('template_directory') ?>/assets/images/services/style1/1.png" alt=""> 
                                   </div>
                               </div>
                        ...
                        <div class="col-lg-3 col-md-6 md-mb-30">
                           <div class="services-item">
                               <div class="services-icon">
                                   <div class="image-part">
                                       <img src="<?php bloginfo ('template_directory') ?>/assets/images/services/style1/2.png" alt="">  
                                   </div>
                               </div>
                               <div class="services-content">
                                   <div class="services-text">
                        ...
                        <div class="col-lg-3 col-md-6 sm-mb-30">
                           <div class="services-item">
                               <div class="services-icon">
                                   <div class="image-part">
                                       <img src="<?php bloginfo ('template_directory') ?>/assets/images/services/style1/3.png" alt="">  
                                   </div>
                               </div>
                               <div class="services-content">
                                   <div class="services-text">
                        ...
                        <div class="col-lg-3 col-md-6">
                           <div class="services-item">
                               <div class="services-icon">
                                   <div class="image-part">
                                       <img src="<?php bloginfo ('template_directory') ?>/assets/images/services/style1/4.png" alt=""> 
                                   </div>
                               </div>
                               <div class="services-content">
                                   <div class="services-text">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6 md-mb-50">
                            <div class="images">
                               <img src="<?php bloginfo ('template_directory') ?>/assets/images/about/about-2.png" alt=""> 
                            </div> 
                        </div>
            ...
            <div id="rs-services" class="pt-relative rs-services style4 modify1 services3 gray-color pt-120 md-pt-80">
                ...
                <div class="bg-section pb-120 md-pb-80">
                    <div class="container">
                        <div class="row gray-color pb-35 pl-25 pr-25 md-pl-0 md-pr-0">
                            <div class="col-lg-4 col-md-6 mb-20">
                                <div class="services-item">
                                    <div class="services-icon">
                                        <img src="<?php bloginfo ('template_directory') ?>/assets/images/services/main-home/icons/1.png" alt="">
                                    </div>
                                    <div class="services-content">
                            ...
                            <div class="col-lg-4 col-md-6 mb-20">
                                <div class="services-item">
                                    <div class="services-icon">
                                        <img src="<?php bloginfo ('template_directory') ?>/assets/images/services/main-home/icons/2.png" alt="">
                                    </div>
                                    <div class="services-content">
                            ...
                            <div class="col-lg-4 col-md-6 mb-20">
                                <div class="services-item">
                                    <div class="services-icon">
                                        <img src="<?php bloginfo ('template_directory') ?>/assets/images/services/main-home/icons/3.png" alt="">
                                    </div>
                                    <div class="services-content">
                            ...
                            <div class="col-lg-4 col-md-6 md-mb-20">
                                <div class="services-item">
                                    <div class="services-icon">
                                        <img src="<?php bloginfo ('template_directory') ?>/assets/images/services/main-home/icons/4.png" alt="">
                                    </div>
                                    <div class="services-content">
                            ...
                            <div class="col-lg-4 col-md-6 sm-mb-20">
                                <div class="services-item">
                                    <div class="services-icon">
                                        <img src="<?php bloginfo ('template_directory') ?>/assets/images/services/main-home/icons/5.png" alt="">
                                    </div>
                                    <div class="services-content">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="services-item">
                                    <div class="services-icon">
                                        <img src="<?php bloginfo ('template_directory') ?>/assets/images/services/main-home/icons/6.png" alt="">
                                    </div>
                                    <div class="services-content">
                    ...
                    <div class="shape-part">
                        <div class="left-side">
                           <img src="<?php bloginfo ('template_directory') ?>/assets/images/services/shape-2.png" alt=""> 
                        </div>
                        <div class="right-side">
                            <img src="<?php bloginfo ('template_directory') ?>/assets/images/services/shape-3.png" alt=""> 
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="rs-call-us bg1 pt-120 md-pt-80">                
                <div class="container">
                    <div class="row rs-vertical-middle">
                        <div class="col-lg-6">
                            <div class="image-part">
                              <img src="<?php bloginfo ('template_directory') ?>/assets/images/call-us/contact-here.png" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30" data-autoplay="true" data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800" data-dots="false" data-nav="false" data-nav-speed="false" data-center-mode="false" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="2" data-ipad-device-nav="false" data-ipad-device-dots="false" data-ipad-device2="2" data-ipad-device-nav2="false" data-ipad-device-dots2="false" data-md-device="3" data-md-device-nav="true" data-md-device-dots="false">
                        <div class="project-item">
                            <div class="project-img">
                                <a href="#"><img src="<?php bloginfo ('template_directory') ?>/assets/images/project/main-home/1.jpg" alt="images"></a>
                            </div>
                        ...
                        <div class="project-item">
                            <div class="project-img">
                                <a href="#"><img src="<?php bloginfo ('template_directory') ?>/assets/images/project/main-home/2.jpg" alt="images"></a>
                            </div>
                            <div class="project-content">
                        ...
                        <div class="project-item">
                            <div class="project-img">
                                <a href="#"><img src="<?php bloginfo ('template_directory') ?>/assets/images/project/main-home/3.jpg" alt="images"></a>
                            </div>
                            <div class="project-content">
                        ...
                        <div class="project-item">
                            <div class="project-img">
                                <a href="#"><img src="<?php bloginfo ('template_directory') ?>/assets/images/project/main-home/4.jpg" alt="images"></a>
                            </div>
                            <div class="project-content">
                        ...
                        <div class="project-item">
                            <div class="project-img">
                                <a href="#"><img src="<?php bloginfo ('template_directory') ?>/assets/images/project/main-home/5.jpg" alt="images"></a>
                            </div>
                            <div class="project-content">
                        ...
                        <div class="project-item">
                            <div class="project-img">
                                <a href="#"><img src="<?php bloginfo ('template_directory') ?>/assets/images/project/main-home/6.jpg" alt="images"></a>
                            </div>
                            <div class="project-content">
                   ...
                   <div class="row">
                       <div class="col-lg-4 md-mb-50">
                           <div class="pricing-table new-style">
                               ...
                               <div class="pricing-icon">
                                   <img src="<?php bloginfo ('template_directory') ?>/assets/images/pricing/main-home/icons/1.png" alt="">
                               </div>
                       ...
                       <div class="col-lg-4 md-mb-50">
                           <div class="pricing-table primary-bg">
                               ...
                               <div class="pricing-icon">
                                   <img src="<?php bloginfo ('template_directory') ?>/assets/images/pricing/main-home/icons/2.png" alt="">
                               </div>
                              <div class="pricing-table-price">
                                   <div class="pricing-table-bags">
                                       <span class="pricing-currency">$</span>
                       ...
                       <div class="col-lg-4">
                           <div class="pricing-table new-style">
                               ...
                               <div class="pricing-icon">
                                   <img src="<?php bloginfo ('template_directory') ?>/assets/images/pricing/main-home/icons/3.png" alt="">
                               </div>
                                <div class="pricing-table-price">
                                     <div class="pricing-table-bags">
                                         <span class="pricing-currency">$</span>
                    ...
                    <div class="container"> 
                        <div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30" data-autoplay="true" data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800" data-dots="false" data-nav="false" data-nav-speed="false" data-center-mode="false" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="true" data-ipad-device="2" data-ipad-device-nav="false" data-ipad-device-dots="true" data-ipad-device2="2" data-ipad-device-nav2="false" data-ipad-device-dots2="true" data-md-device="3" data-md-device-nav="false" data-md-device-dots="true">
                            <div class="team-item-wrap">
                                <div class="team-wrap">
                                    <div class="image-inner">
                                        <a href="#"><img src="<?php bloginfo ('template_directory') ?>/assets/images/team/style1/1.jpg" alt=""></a>
                                    </div>
                                </div>
                            ...
                            <div class="team-item-wrap">
                                <div class="team-wrap">
                                    <div class="image-inner">
                                        <a href="#"><img src="<?php bloginfo ('template_directory') ?>/assets/images/team/style1/2.jpg" alt=""></a>
                                    </div>
                                </div>
                                <div class="team-content text-center">
                            ...
                            <div class="team-item-wrap">
                                <div class="team-wrap">
                                    <div class="image-inner">
                                        <a href="#"><img src="<?php bloginfo ('template_directory') ?>/assets/images/team/style1/3.jpg" alt=""></a>
                                    </div>
                                </div>
                                <div class="team-content text-center">
                            ...
                            <div class="team-item-wrap">
                                <div class="team-wrap">
                                    <div class="image-inner">
                                        <a href="#"><img src="<?php bloginfo ('template_directory') ?>/assets/images/team/style1/4.jpg" alt=""></a>
                                    </div>
                                </div>
                                <div class="team-content text-center">
                            ...
                            <div class="team-item-wrap">
                                <div class="team-wrap">
                                    <div class="image-inner">
                                        <a href="#"><img src="<?php bloginfo ('template_directory') ?>/assets/images/team/style1/5.jpg" alt=""></a>
                                    </div>
                                </div>
                                <div class="team-content text-center">
                            ...
                            <div class="team-item-wrap">
                                <div class="team-wrap">
                                    <div class="image-inner">
                                        <a href="#"><img src="<?php bloginfo ('template_directory') ?>/assets/images/team/style1/6.jpg" alt=""></a>
                                    </div>
                                </div>
                                <div class="team-content text-center">
                            ...
                            <div class="team-item-wrap">
                                <div class="team-wrap">
                                    <div class="image-inner">
                                        <a href="#"><img src="<?php bloginfo ('template_directory') ?>/assets/images/team/style1/7.jpg" alt=""></a>
                                    </div>
                                </div>
                                <div class="team-content text-center">
                            ...
                            <div class="team-item-wrap">
                                <div class="team-wrap">
                                    <div class="image-inner">
                                        <a href="#"><img src="<?php bloginfo ('template_directory') ?>/assets/images/team/style1/8.jpg" alt=""></a>
                                    </div>
                                </div>
                                <div class="team-content text-center">
                            ...
                            <div class="team-item-wrap">
                                <div class="team-wrap">
                                    <div class="image-inner">
                                        <a href="#"><img src="<?php bloginfo ('template_directory') ?>/assets/images/team/style1/9.jpg" alt=""></a>
                                    </div>
                                </div>
                                <div class="team-content text-center">
                    ...
                    <div class="rs-carousel owl-carousel" 
                        ...
                        <div class="testi-item">
                            <div class="author-desc">                                
                                <div class="desc"><img class="quote" src="<?php bloginfo ('template_directory') ?>/assets/images/testimonial/main-home/quote-white.png" alt="">Capitalize on low hanging fruit to identify a ballpark value added activity to beta test. Override the digital divide with additional clickthroughs from DevOps. Nanotechnology immersion along the information highway.</div>
                                <div class="author-img">
                                    <img src="<?php bloginfo ('template_directory') ?>/assets/images/testimonial/main-home/1.jpg" alt="">
                                </div>
                            </div>
                        ...
                        <div class="testi-item">
                            <div class="author-desc">                                
                                <div class="desc"><img class="quote" src="<?php bloginfo ('template_directory') ?>/assets/images/testimonial/main-home/quote-white.png" alt="">Capitalize on low hanging fruit to identify a ballpark value added activity to beta test. Override the digital divide with additional clickthroughs from DevOps. Nanotechnology immersion along the information highway.</div>
                                <div class="author-img">
                                    <img src="<?php bloginfo ('template_directory') ?>/assets/images/testimonial/main-home/2.jpg" alt="">
                                </div>
                            </div>
                            <div class="author-part">
                        ...
                        <div class="testi-item">
                            <div class="author-desc">                                
                                <div class="desc"><img class="quote" src="<?php bloginfo ('template_directory') ?>/assets/images/testimonial/main-home/quote-white.png" alt="">Capitalize on low hanging fruit to identify a ballpark value added activity to beta test. Override the digital divide with additional clickthroughs from DevOps. Nanotechnology immersion along the information highway.</div>
                                <div class="author-img">
                                    <img src="<?php bloginfo ('template_directory') ?>/assets/images/testimonial/main-home/3.jpg" alt="">
                                </div>
                            </div>
                            <div class="author-part">
                        ...
                        <div class="testi-item">
                            <div class="author-desc">                                
                                <div class="desc"><img class="quote" src="<?php bloginfo ('template_directory') ?>/assets/images/testimonial/main-home/quote-white.png" alt="">Capitalize on low hanging fruit to identify a ballpark value added activity to beta test. Override the digital divide with additional clickthroughs from DevOps. Nanotechnology immersion along the information highway.</div>
                                <div class="author-img">
                                    <img src="<?php bloginfo ('template_directory') ?>/assets/images/testimonial/main-home/4.jpg" alt="">
                                </div>
                            </div>
                            <div class="author-part">
                    ...
                    <div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30" data-autoplay="true" data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800" data-dots="false" data-nav="false" data-nav-speed="false" data-center-mode="false" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="2" data-ipad-device-nav="false" data-ipad-device-dots="false" data-ipad-device2="2" data-ipad-device-nav2="false" data-ipad-device-dots2="false" data-md-device="3" data-md-device-nav="false" data-md-device-dots="false">
                        <div class="blog-item">
                            <div class="image-wrap">
                                <a href="#"><img src="<?php bloginfo ('template_directory') ?>/assets/images/blog/main-home/1.jpg" alt=""></a>
                        ...
                        <div class="blog-item">
                            <div class="image-wrap">
                                <a href="#"><img src="<?php bloginfo ('template_directory') ?>/assets/images/blog/main-home/2.jpg" alt=""></a>
                                <ul class="post-categories">
                        ...
                        <div class="blog-item">
                            <div class="image-wrap">
                                <a href="#"><img src="<?php bloginfo ('template_directory') ?>/assets/images/blog/main-home/3.jpg" alt=""></a>
                                <ul class="post-categories">
                        ...
                        <div class="blog-item">
                            <div class="image-wrap">
                                <a href="#"><img src="<?php bloginfo ('template_directory') ?>/assets/images/blog/main-home/4.jpg" alt=""></a>
                                <ul class="post-categories">
                        ...
                        <div class="blog-item">
                            <div class="image-wrap">
                                <a href="#"><img src="<?php bloginfo ('template_directory') ?>/assets/images/blog/main-home/5.jpg" alt=""></a>
                                <ul class="post-categories">
                        ...
                        <div class="blog-item">
                            <div class="image-wrap">
                                <a href="#"><img src="<?php bloginfo ('template_directory') ?>/assets/images/blog/main-home/6.jpg" alt=""></a>
                                <ul class="post-categories">
                                    <li><a href="blog-details.html">It Services</a></li>
                                </ul>
                            </div>
                ...
                <div class="container">
                    <div class="rs-carousel owl-carousel" data-loop="true" data-items="5" data-margin="30" data-autoplay="true" data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800" data-dots="false" data-nav="false" data-nav-speed="false" data-center-mode="false" data-mobile-device="2" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="3" data-ipad-device-nav="false" data-ipad-device-dots="false" data-ipad-device2="2" data-ipad-device-nav2="false" data-ipad-device-dots2="false" data-md-device="5" data-md-device-nav="false" data-md-device-dots="false">
                        <div class="partner-item">
                            <div class="logo-img">
                                <a href="#">
                                    <img class="hover-logo" src="<?php bloginfo ('template_directory') ?>/assets/images/partner/1.png" alt="">
                                    <img class="main-logo" src="<?php bloginfo ('template_directory') ?>/assets/images/partner/1.png" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="partner-item">
                            <div class="logo-img">
                                <a href="#">
                                    <img class="hover-logo" src="<?php bloginfo ('template_directory') ?>/assets/images/partner/2.png" alt="">
                                    <img class="main-logo" src="<?php bloginfo ('template_directory') ?>/assets/images/partner/2.png" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="partner-item">
                            <div class="logo-img">
                                <a href="#">
                                    <img class="hover-logo" src="<?php bloginfo ('template_directory') ?>/assets/images/partner/3.png" alt="">
                                    <img class="main-logo" src="<?php bloginfo ('template_directory') ?>/assets/images/partner/3.png" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="partner-item">
                            <div class="logo-img">
                                <a href="#">
                                    <img class="hover-logo" src="<?php bloginfo ('template_directory') ?>/assets/images/partner/4.png" alt="">
                                    <img class="main-logo" src="<?php bloginfo ('template_directory') ?>/assets/images/partner/4.png" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="partner-item">
                            <div class="logo-img">
                                <a href="#">
                                    <img class="hover-logo" src="<?php bloginfo ('template_directory') ?>/assets/images/partner/5.png" alt="">
                                    <img class="main-logo" src="<?php bloginfo ('template_directory') ?>/assets/images/partner/5.png" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="partner-item">
                            <div class="logo-img">
                                <a href="#">
                                    <img class="hover-logo" src="<?php bloginfo ('template_directory') ?>/assets/images/partner/6.png" alt="">
                                    <img class="main-logo" src="<?php bloginfo ('template_directory') ?>/assets/images/partner/6.png" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="partner-item">
                            <div class="logo-img">
                                <a href="#">
                                    <img class="hover-logo" src="<?php bloginfo ('template_directory') ?>/assets/images/partner/7.png" alt="">
                                    <img class="main-logo" src="<?php bloginfo ('template_directory') ?>/assets/images/partner/7.png" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="partner-item">
                            <div class="logo-img">
                                <a href="#">
                                    <img class="hover-logo" src="<?php bloginfo ('template_directory') ?>/assets/images/partner/8.png" alt="">
                                    <img class="main-logo" src="<?php bloginfo ('template_directory') ?>/assets/images/partner/8.png" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="partner-item">
                            <div class="logo-img">
                                <a href="#">
                                    <img class="hover-logo" src="<?php bloginfo ('template_directory') ?>/assets/images/partner/9.png" alt="">
                                    <img class="main-logo" src="<?php bloginfo ('template_directory') ?>/assets/images/partner/9.png" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
