...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="table-responsive">
            ...
            <table class="table wp-list-table widefat table-striped table-bordered dt-responsive" id="pqr-file-listing" width="100%" cellspacing="0">
                <thead>
                    <tr>
    ...
    <script src="<?php bloginfo('template_directory') ?>/inc/templates/js/js_views/pqr/pqr.js"></script>
    <script src="<?php bloginfo('template_directory') ?>/inc/templates/js/js_views/pqr/pqr_edit.js"></script>
</body>
