...
<body>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-md-12">
                                                <div class="mb-2">
                                                    ...
                                                    <?php
                                                    global $wpdb;
                                                    $data = $wpdb->get_results("SELECT DISTINCT subfolder_n1_row_id,subfolder_n1_name FROM vw_wpl_folders WHERE folder_row_id=1");
    ...
    <div class="modal fade" id="editFileModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="editFileModal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editFileModalTitle"><i class="ti-pencil-alt" style="color:#B61020;font-size:22px;cursor:pointer"></i> Editar archivo</h5>
                        ...
                        <div class="form-group row">
                            <div class="col-xl-12">
                                <fieldset class="scheduler-border">
                                    <legend class="scheduler-border twentyseventeen-font-size-theme-16">
                                        <div class="alert alert-warning" role="alert">
                                            Para que la información se actualice, debe dar clic en guardar.
                                        </div>
                                    </legend>
                                    <div class="control-group">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-md-12">
                                                <div class="mb-2">
                                                    <label for="file-upload-edit" class="col-form-label text-dark m-0">Cargar archivo</label>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-md-12">
                                                <div class="mb-2">
                                                    <label for="name-folder-upload-edit" class="col-form-label text-dark m-0" style="font-weight:bold;padding:0">Carpeta principal<span class="required">*</span></label>
                                                    <?php
                                                    global $wpdb;
                                                    $data = $wpdb->get_results("SELECT DISTINCT folder_row_id,folder_name FROM vw_wpl_folders WHERE folder_row_id=1");
                                                    echo '<select id="name-folder-upload-edit" name="name-folder-upload-edit" class="form-control form-control-sm input-xs text-center validateText" placeholder="Carpeta" style="max-width: inherit;">';
                                                    foreach ($data as $damenu) {
                                                        echo '<option value="' . $damenu->folder_row_id . '">' . $damenu->folder_name . '</option>';
                                                    }
                                                    echo "</select>";
                                                    ?>
                                                    <small id="name-folder-upload-editError" class="form-text text-danger font-weight-bold"></small>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xl-12 col-md-12">
                                                <div class="mb-2">
                                                    <label for="name-subfolder-upload-edit" class="col-form-label text-dark m-0" style="font-weight:bold;padding:0">Sub carpeta<span class="required">*</span></label>
                                                    <?php
                                                    global $wpdb;
                                                    $data = $wpdb->get_results("SELECT DISTINCT subfolder_n1_row_id,subfolder_n1_name FROM vw_wpl_folders WHERE folder_row_id=1");
                                                    echo '<select id="name-subfolder-upload-edit" name="name-subfolder-upload-edit" class="form-control form-control-sm input-xs text-center validateText" placeholder="Carpeta" style="max-width: inherit;">';
                                                    foreach ($data as $damenu) {
                                                        echo '<option value="' . $damenu->subfolder_n1_row_id . '">' . $damenu->subfolder_n1_name . '</option>';
                                                    }
                                                    echo "</select>";
                                                    ?>
                                                    <small id="name-subfolder-upload-editError" class="form-text text-danger font-weight-bold"></small>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" style="min-width: 90px;" class="btn btn-danger btn-sm twentyseventeen-font-size-theme-15-5" onclick="uploadFileEdit()">Guardar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="<?php bloginfo('template_directory') ?>/inc/templates/js/js_views/marketing/marketing_advertising_edit.js"></script>
</body>
