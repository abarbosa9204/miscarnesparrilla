    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.status == 'success') {
                ...
                $('#name-file-upload-edit').val(data.qu_description);
                $('#text-file-description-edit').val(data.qu_text_information);
                $('#file-upload-status').val(data.qu_status);
            }
        },
        error: function (msg) {
            setTimeout(function () {
...
function uploadFileEdit() {
    ...
    processModalSaveEdit.init(function () {
        ...
        form_data.append('function', 'uploadFilesQualityEdit');
