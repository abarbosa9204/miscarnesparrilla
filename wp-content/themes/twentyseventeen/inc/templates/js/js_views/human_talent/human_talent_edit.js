...
function showModalEditFile(id) {
    $.ajax({
        ...
        dataType: 'json',
        data: {
            controller: 'HumanTalentController',
            action: 'human_talent',
        ...
        success: function (data) {
            if (data.status == 'success') {
                ...
                $('#name-file-upload-edit').val(data.ht_description);
                $('#text-file-description-edit').val(data.ht_text_information);
                $('#file-upload-status').val(data.ht_status);
            }
        },
        error: function (msg) {
            setTimeout(function () {
...
function uploadFileEdit() {
    ...
    processModalSaveEdit.init(function () {
        ...
        form_data.append('controller', 'HumanTalentController');
        form_data.append('action', 'human_talent_upload_files');
        form_data.append('function', 'uploadFilesHumanTalentEdit');
            ...
            success: function (data) {
                setTimeout(function () {
                    if (data.status == 'success') {
                        ...
                        $('#human-talent-file-listing').DataTable().ajax.reload(null, false);
