    ...
    $.ajax({
        ...
        success: function (data) {            
            if (data.status == 'success') {
                ...
                $('#name-file-upload-edit').val(data.pqr_description);
                $('#text-file-description-edit').val(data.pqr_text_information);
                $('#file-upload-status').val(data.pqr_status);
            }
        },
        error: function (msg) {
            setTimeout(function () {
...
function uploadFileEdit() {
    ...
    processModalSaveEdit.init(function () {
        ...
        form_data.append('controller', 'PqrController');
        form_data.append('action', 'pqr_upload_files');
        form_data.append('function', 'uploadFilesPqrEdit');
            ...
            success: function (data) {                             
                setTimeout(function () {
                    if (data.status == 'success') {
                        ...
                        $('#pqr-file-listing').DataTable().ajax.reload(null, false);
