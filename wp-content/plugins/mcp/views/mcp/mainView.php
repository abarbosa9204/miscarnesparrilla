                ...
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        ...
                        <div class="card-block">
                            <h4 class="card-title">Procedimiento Recepción de materias primas</h4>
                            <div class="centered">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <img class="card-img-top" src="">
                        <div class="card-block">
                            <h4 class="card-title">COCINA - Manual de operaciones - v02</h4>
                            <div class="centered">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <img class="card-img-top" src="">
                        <div class="card-block">
                            <h4 class="card-title">Registro de Recepción de Materias Primas - v1</h4>
                            <div class="centered">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <img class="card-img-top" src="">
                        <div class="card-block">
                            <h4 class="card-title">Servicio - MANUAL OPERACIONES - versión 2</h4>
                            <div class="centered">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <img class="card-img-top" src="">
                        <div class="card-block">
                            <h4 class="card-title">PARRILLA - Manual de Operaciones - v02</h4>
                            <div class="centered">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <img class="card-img-top" src="">
                        <div class="card-block">
                            <h4 class="card-title">BAR - Manual de Operaciones - versión 02</h4>
                            <div class="centered">
